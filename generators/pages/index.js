  ...
  writing() {
    ...
    if (this.props.store && !this.props.loadable) {
        ...
        this.fs.copyTpl(
          ...
          this.destinationPath(`src/pages/${this.props.componentName}/index.js`),
          this.props
        )
         this.fs.copyTpl(
          this.templatePath('header/style.js'),
          this.destinationPath(`src/pages/${this.props.componentName}/style.js`),
          this.props
        )
         //copy store
        filePath.forEach(i=>{
          ...
          this.destinationPath(`src/pages/${this.props.componentName}/${i.dest}`)
        )
        }) 
